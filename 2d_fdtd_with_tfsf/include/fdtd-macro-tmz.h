...
/* Macros that permit the "Grid" pointer to be specified explicitly */

/* One-dimensional grid access */
...
/* Macros that assume a default global or local grid variable named "g" */
