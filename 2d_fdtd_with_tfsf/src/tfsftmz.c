...
void tfsfInit(Grid *g) {
  ...
  memcpy(g1, g, sizeof(Grid)); // copy information from 2D array, this is shallow copy whihc means heap arrays are not copied
...
/*he 1D auxiliary grid field is injected into 
the 2D grid inside tfsfUpdate through the arithmetic modification
 operators (-= and +=) applied along the boundary edge loops.*/
